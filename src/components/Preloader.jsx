    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#9E5555] z-[100000] flex items-center justify-center"
        >
          <motion.div
          ...
          >
            <div className="text-red-900/30">
              {brand}<span className="text-red-900/30">.</span>
            </div>
            <motion.div
            ...
            >
              {brand}<span className="text-black">.</span>
            </motion.div>
          </motion.div>
        </motion.div>
      )}
